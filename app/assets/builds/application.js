...
%o`, message, error2, detail);
  ...
  // app/javascript/controllers/crucero_controller.js
  var crucero_controller_default = class extends Controller {
    connect() {
    }
    loadDestinations(e) {
      debugger;
  ...
  application.register("crucero--controller", crucero_controller_default);
